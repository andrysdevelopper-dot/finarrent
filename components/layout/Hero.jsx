        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-accent">solutions de financement</span>{' '}
              et{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-white">d&apos;assurance</span>{' '}
              adaptées
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/contact" className="px-8 py-4 bg-white text-primary font-bold rounded-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 inline-flex items-center space-x-2">
                <span>Obtenir un financement</span>
                <i className="fa-solid fa-arrow-right"></i>
              </Link>
              <Link href="/assurance" className="px-8 py-4 bg-accent/90 hover:bg-accent text-white font-bold rounded-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 inline-flex items-center space-x-2">
                <i className="fa-solid fa-shield-halved"></i>
                <span>Assurance Pro</span>
              </Link>
              <Link href="/process" className="px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-bold rounded-xl hover:bg-white/20 transition-all duration-300 border-2 border-white/30 inline-flex items-center space-x-2">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
              <div className="h-64 overflow-hidden rounded-2xl mb-6">
                <img className="w-full h-full object-cover" src="https://storage.googleapis.com/uxpilot-auth.appspot.com/a94c12e6b2-de3b0a26544f06bb6d8f.png" alt="Professional business team" />
              </div>
