  ...
  return (
    <div className="border-t border-white/20 pt-8">
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div>
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-2 text-sm">
            <Link href="/legal" className="text-white/60 hover:text-white transition-colors">Mentions légales</Link>
            <span className="text-white/30">•</span>
            <Link href="/terms" className="text-white/60 hover:text-white transition-colors">CGU</Link>
            <span className="text-white/30">•</span>
            <Link href="/privacy" className="text-white/60 hover:text-white transition-colors">Politique de confidentialité</Link>
          </div>
        </div>
        <div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-6 border-t border-white/10">
        <div className="text-white/60 text-sm text-center md:text-left">© 2025 Finassur. Tous droits réservés.</div>
      </div>
    </div>
  );
}
